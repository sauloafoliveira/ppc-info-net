...
\newcommand{\pudinfo}[8]{
	...
	%\section{#2}
		\begin{center}
			\cabecalho
		\end{center}
		\noindent\begin{tabularx}{\linewidth}{ p{3.5cm} X X} 
		
%		\multicolumn{3}{c}{\cabecalho} \\
%		
		\multicolumn{3}{p{\textwidth-2\tabcolsep}}{\cellcolor{gray!10}DISCIPLINA: \bfseries #2} \\

		C\'odigo: \bfseries #1 & 
		Carga horária total: \bfseries \MULTIPLY{20}{#6}{\solution} \solution{h} &
		Créditos: \bfseries #6 \\
		
		Nível: \bfseries Técnico &
		Semestre: \bfseries #7 &
		Pré-requisitos: \bfseries  {\tiny #3} \\
		
		 \ifthenelse{\equal{TSII.203}{#1} \OR \equal{TSII.204}{#1} \OR \equal{TSII.304}{#1}}{
		 	
			\ifthenelse{\equal{TSII.304}{#1}}{
				& Teórica: \bfseries 24{h}  &
			}{
				&  Teórica: \bfseries 28h  &
			}
			Prática: \bfseries  0h \\	
			
		 }{
		 	& 
			Teórica: \bfseries #4{h}  &
			Prática: \bfseries #5{h} \\
...
%		& 
%		Teórica: \bfseries #4{h}  &
%		Prática: \bfseries  \ifthenelse{\equal{TSII.203}{#1} \OR \equal{TSII.204}{#1} \OR \equal{TSII.304}{#1}}{#5}{0}h \\
		
		&
		Presencial: \bfseries \ifthenelse{\equal{2}{#6}}{40}{80}h  &
		Distância: \bfseries 0h \\
		
		Carga Horária &
		\ifthenelse{\equal{TSII.203}{#1} \OR \equal{TSII.204}{#1} \OR \equal{TSII.304}{#1}}{			
			\ifthenelse{\equal{TSII.304}{#1}}{
				Prática Profissional:  \bfseries 16{h} 
			}{
				Prática Profissional: \bfseries 12{h} 
			}			
		}{
			Prática Profissional: \bfseries  {0}h 
		}\\
		
		&
		\multicolumn{2}{p{.6\textwidth}}{Atividades não presenciais: \bfseries \ifthenelse{\equal{2}{#6}}{8}{16}h }  \\

		&
		\multicolumn{2}{p{.6\textwidth}}{Extensão: \bfseries 0{h}}  \\
...
\begin{pud}
	...
	\begin{bibbasica}
		...
		\item CERVO, Amado Luiz; BERVIAN, Pedro Alcino; SILVA, Roberto da. \textbf{Metodologia científica}. 6. ed. São Paulo: Pearson Prentice Hall, 2007. 159 p. Inclui bibliografia. ISBN 8576050471.    %CAMPUS TAUÁ: 7 ex. 001.42 C419m
...
\begin{pud}
	...
	\begin{bibbasica}
		\item DEGEN, Ronald Jean. \textbf{O Empreendedor}: fundamentos da iniciativa empresarial. 8. ed. Editora Pearson. Livro. 384 p. ISBN 9788534602174.   % Disponível em: <http://ifce.bv3.digitalpages.com.br/users/publications/9788534602174>. Acesso em: 31 mar. 2020.
		...
		\item SERTEK, Paulo. \textbf{Empreendedorismo}.  Editora Intersaberes. Livro. 240 p.  ISBN 9788565704199.  %Disponível em: <http://ifcefortaleza.bv3.digitalpages.com.br/users/publications/9788565704199/pages/-2>. Acesso em: 31 mar. 2020.
	...
	\begin{bibcomplementar}
        ...
        \item DEGEN, Ronald Jean. \textbf{O Empreendedor}: empreender como opção de carreira. São Paulo: Pearson Prentice Hall, 2009. 440 p. ISBN 9788576052050.  
         ...
         \item MAXIMIANO, Antonio Cesar Amaru. \textbf{Administração para empreendedores}: fundamentos da criação e gestão de novos negócios. 2. ed. Pearson.  258 p. ISBN 9788576058762.   %Disponível em: <http://ifce.bv3.digitalpages.com.br/users/publications/9788576058762>. Acesso em: 31 mar. 2020.
